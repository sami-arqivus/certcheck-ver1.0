...
const PublicProfileView: React.FC = () => {
  ...
  const fetchUserData = async () => {
    ...
    try {
      ...
      // Fetch user profile
      const profileResponse = await axios.get(`http://localhost/api/public/profile/${userid}`);
      setUserProfile(profileResponse.data);
      console.log(profileResponse.data)
      // Fetch verified cards
      const cardsResponse = await axios.get(`http://localhost/api/public/verified-cards/${userid}`);
